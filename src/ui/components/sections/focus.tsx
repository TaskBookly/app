...
const Focus = () => {
	...
	useEffect(() => {
		const removePresetMenuActionListener = window.electron.focusPresets.onMenuAction((action) => {
			if (action === 'new') {
		...
		return removePresetMenuActionListener;
	}, [handleEditPreset, handleNewPreset]);
