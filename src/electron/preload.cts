...
contextBridge.exposeInMainWorld('electron', {
	...
	focusPresets: {
		...
		onMenuAction: (callback) => {
			const handler = (_event: any, action: 'new' | 'edit') => callback(action);
			ipcRenderer.on('focus-presets-menu-action', handler);
			return () => ipcRenderer.removeListener('focus-presets-menu-action', handler);
		},
	},
	sound: {
